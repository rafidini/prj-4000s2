...
rem Python 2.7
set PATH=%PATH%;D:\Build\Python26_64
set INCLUDE=%INCLUDE%;D:\Build\boost_1_49_0\boost_python26\boost_1_49_0
set LIB=%LIB%;D:\Build\boost_1_49_0\boost_python26\boost_1_49_0\stage\lib
set LIB=%LIB%;D:\Build\Python26_64\libs
