...
rem Python 2.7
set PATH=%PATH%;D:\Build\Python32_64
set INCLUDE=%INCLUDE%;D:\Build\boost_1_49_0\boost_python32\boost_1_49_0
set LIB=%LIB%;D:\Build\boost_1_49_0\boost_python32\boost_1_49_0\stage\lib
set LIB=%LIB%;D:\Build\Python32_64\libs
